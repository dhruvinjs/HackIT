    ...
    return (
        <div className='w-full flex items-center justify-center min-h-screen bg-black'>
            <div className="w-full max-w-sm p-6  bg-white rounded-lg shadow-md dark:bg-[#1B1C1D]">
                ...
                <p className="mt-8 text-xs font-light text-center text-gray-400"> Already Registered ?<Link to="#" className="font-medium text-gray-700 dark:text-gray-200 hover:underline">Login</Link></p>
            </div>
        </div>
    )
}
