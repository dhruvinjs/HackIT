          ...
          <form>
            <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
              <div class="sm:col-span-3">
                <label class="inline-block text-lg text-gray-800 mt-2.5 dark:text-neutral-200">
                  Profile photo
                </label>
              </div>
                ...
                <div class="flex items-center gap-5">
                  ...
                  <div class="flex gap-x-2">
                    <div>
                      <button
                        type="button"
                        class="py-2 px-3 inline-flex items-center gap-x-2 text-lg font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:bg-gray-50 dark:bg-transparent dark:border-neutral-700 dark:text-neutral-300 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                      >
                        <svg
              ...
              <div class="sm:col-span-3">
                <label
                  for="fullname"
                  class="inline-block text-lg text-gray-800 mt-2.5 dark:text-neutral-200"
                >
                  Full name
                </label>
              ...
              <div class="sm:col-span-9">
                <div class="sm:flex">
                  <input
                    id="fullname"
                    type="text"
                    class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-lg rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-white dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                    placeholder="Nihal Panday"
                  />
                </div>
              </div>
              ...
              <div class="sm:col-span-9">
                <div class="space-y-2">
                  <input
                    id="clg-name"
                    type="text"
                    class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm rounded-lg text-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-white dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
              ...
              <div class="sm:col-span-9">
                <div class="sm:flex">
                  ...
                  >
                    ...
                    />
                    <span class="text-lg text-gray-500 ms-3 dark:text-white">
                      Male
                    </span>
                  </label>
            ...
            <div class="mt-5 flex justify-end gap-x-2">
              ...
              <button
                type="button"
                class="py-2 px-3 inline-flex items-center gap-x-2 text-lg font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
              >
                Save changes
              </button>
            </div>
