          ...
          <div class="grid max-w-4xl lg:max-w-6xl grid-cols-1 mx-auto mt-8 text-center gap-y-4 sm:gap-x-8 sm:grid-cols-2 lg:grid-cols-3 sm:mt-12 lg:mt-20 sm:text-left">
            <div class="relative">
              <div class="absolute -inset-1">
                <div class="w-full h-full rotate-180 opacity-100 blur-sm filter bg-gradient-to-r from-blue-400 via-violet-500 to-purple-600 "></div>
              </div>
              <div class="relative overflow-hidden bg-black shadow-md rounded-xl h-full">
                <div class="p-9">
                  ...
                  <h3 class="mt-6 text-2xl font-bold text-white sm:mt-10">
                    Event Creation
                  </h3>
