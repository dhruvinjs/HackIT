...
function Feature() {
  return (
    <div>
      <section className="py-12 dark:bg-[#151515] text-gray-100 sm:py-12 lg:py-16">
          ...
          <div className="grid max-w-4xl lg:max-w-6xl grid-cols-1 mx-auto mt-8 text-center gap-y-4 sm:gap-x-8 sm:grid-cols-2 lg:grid-cols-3 sm:mt-12 lg:mt-20 sm:text-left">
            <div className="relative">
              <div className="absolute -inset-1">
                <div className="w-full h-full rotate-180 opacity-100 blur-sm filter bg-gradient-to-r from-blue-400 via-violet-500 to-purple-600 "></div>
              </div>
              <div className="relative overflow-hidden bg-black shadow-md rounded-xl h-full">
                <div className="p-9">
                  <svg
            ...
            <div className="overflow-hidden bg-black shadow-md rounded-xl">
              <div className="p-9">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="40px"
