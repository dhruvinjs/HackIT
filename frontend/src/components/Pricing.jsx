            ...
            <div class="pt-5 dark:bg-[#151515]" id="pricing">
                <div class="mx-auto pb-20 mt-4 max-w-7xl px-6 lg:px-8">
                    <div class="mx-auto max-w-4xl text-center">
                        <h1 class="text-2xl font-semibold leading-7 text-indigo-400">Pricing</h1>
                    ...
                    <div class="isolate mx-auto mt-10 grid max-w-md grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                        <div class="ring-1 ring-white/10 rounded-3xl p-8 xl:p-10">
                            <div class="flex items-center justify-between gap-x-4">
                                <h2 id="product1" class="text-2xl font-semibold leading-8 text-white">Starter</h2>
                            </div>
                            <p class="mt-4 text-sm leading-6 text-gray-300">Product details for Starter</p>
                            <p class="mt-6 flex items-baseline gap-x-1">
                                <span class="text-4xl font-bold tracking-tight text-white">₹ 80000/</span><span class="text-xl font-semibold leading-6 text-gray-300">event</span>
                            </p>
                            <a href="/order" aria-describedby="product1"
                                class="bg-white/10 text-white hover:bg-white/20 focus-visible:outline-white mt-6 block rounded-md py-2 px-3 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-offset-2">Get Started</a>
                        ...
                        <div class="bg-white/5 ring-2 ring-indigo-500 rounded-3xl p-8 xl:p-10">
                            <div class="flex items-baseline justify-between gap-x-4">
                                <h2 id="product2" class="text-2xl font-semibold leading-8 text-white">Pro</h2>
                            ...
                            <p class="mt-6 flex items-baseline gap-x-1">
                                <span class="text-4xl font-bold tracking-tight text-white">₹ 150000/</span><span class="text-xl font-semibold leading-6 text-gray-300">event</span>
                            </p>
                        ...
                        <div class="ring-1 ring-white/10 rounded-3xl p-8 xl:p-10">
                            <div class="flex items-center justify-between gap-x-4">
                                <h2 id="product3" class="text-2xl font-semibold leading-8 text-white">Enterprise</h2>
                            </div>
                            <p class="mt-4 text-sm leading-6 text-gray-300">Product details for Enterprise</p>
                            <p class="mt-6 flex items-baseline gap-x-1">
                                <span class="text-4xl font-bold tracking-tight text-white">₹ 250000/</span><span class="text-xl font-semibold leading-6 text-gray-300">event</span>
                            </p>
