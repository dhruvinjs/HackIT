...
function Contact() {
    ...
    return (
        <div className='dark:bg-[#151515]'>
            <section className="min-h-screen   dark:bg-[#151515] md:mx-20">
                <div className="container flex flex-col min-h-screen px-6 py-12 mx-auto">
                    <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
                        <div className="text-white lg:w-1/2 lg:mx-6">
                        <h1 className="text-4xl font-bold capitalize lg:text-5xl">Contact Us</h1>
                            ...
                            <div className="mt-6 space-y-8 md:mt-8">
                                <p className="flex items-start -mx-2">
                                    ...
                                    <span className="mx-2 text-white truncate w-72">
                                        hadapsaar pune maharashtra  411001
                                    </span>
                                </p>
                                ...
                                <p className="flex items-start -mx-2">
                                    ...
                                    <span className="mx-2 text-white truncate w-72">+91-7249865498</span>
                                </p>
                                ...
                                <p className="flex items-start -mx-2">
                                    ...
                                    <span className="mx-2 text-white truncate w-72">nihalpanday2020@gmail.com</span>
                                </p>
                            </div>
                        ...
                        <div className="mt-8 lg:w-1/2 lg:mx-6">
                            <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white rounded-xl dark:bg-black lg:max-w-xl">
                                ...
                                <form className="mt-4">
                                    ...
                                    <div className="w-full mt-6">
                                        ...
                                        <textarea className="block w-full h-32 px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md md:h-48 dark:bg-black  dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" placeholder="Message"></textarea>
                                    </div>
