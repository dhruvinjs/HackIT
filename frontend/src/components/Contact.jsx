...
function Contact() {
    ...
    return (
        <div className='dark:bg-[#151515]'>
            <section class="min-h-screen   dark:bg-[#151515] md:mx-20">
                        ...
                        <h1 class="text-4xl font-bold capitalize lg:text-5xl mb-20">Contact Us</h1>
                            ...
                            <div class="mt-6 space-y-8 md:mt-8">
                                ...
                                <p class="flex items-start -mx-2">
                                    ...
                                    <span class="mx-2 text-white truncate w-72">+91-7249865498</span>
                                </p>
                                ...
                                <p class="flex items-start -mx-2">
                                    ...
                                    <span class="mx-2 text-white truncate w-72">nihalpanday2020@gmail.com</span>
                                </p>
                            </div>
